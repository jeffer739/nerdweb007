...
One of the documented authorized-lab assessments involved a web application with an upload feature protected by a file-extension filter. The assessment demonstrated how relying on a deny-list of extensions can fail when the server accepts another executable extension.
...
The exercise demonstrated two important controls that need to be assessed independently:
